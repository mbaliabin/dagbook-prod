...
export default function EditWorkoutModal({
  ...
  return (
    ...
    >
      ...
      <Dialog.Panel className="relative bg-[#1a1a1d] max-h-[90vh] overflow-y-auto p-4 sm:p-6 rounded-2xl w-full sm:w-[90%] max-w-xl z-50 text-white shadow-2xl">
        <button
          onClick={onClose}
        ...
        <Dialog.Title className="text-xl font-semibold mb-4 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-2 mt-6">
              {isEditing ? (
                <>
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 w-full sm:w-auto"
                  >
                    Сохранить
                  </button>
                </>
